{{-- <div class="ml-auto mb-6 ">
    <div class="sticky z-10 top-0 h-16 border-b bg-white lg:py-2.5">
        <div class="px-6 flex items-start space-x-4 2xl:container">
            <!--/search bar -->
            ...
            <button aria-label="notification"
                ...
                @if (!empty($pesan))
                    <div
                        class=" absolute right-0  z-10 bg-gray-300 text-gray-600 hover:bg-gray-400 top-[-0] rounded-lg text-xs ">
                        {{ $pesan }}
                    </div>
                @endif
            </button>
...
@can('Manage-Admin')
    @if ($cekModal == true)
        <span x-data="{ cekModal: @entangle('cekModal') }">
            @foreach ($stock_habis as $stocks)
                <div
                    class="w-full bg-red-500 bg-opacity-[15%] px-7 py-8 md:p-9 rounded-lg shadow-md shadow-red-600 flex border-l-[6px] border-red-700">
                    <div
                    ...
                    <div class="w-full">
                        ...
                        <p class="text-base text-[#D0915C] leading-relaxed">
                            Pemberitahuan Stock Bahan Baku {{ $stocks->default_stock->bahan_baku }} Hampir Habis. <br>
        ...
        @can('Manage-Admin')
            <div class="md:col-span-2 lg:col-span-1">
                <div class="h-full py-8 px-6 space-y-6 rounded-xl border border-gray-200 bg-white">
                    <div>
                        <h5 class="text-xl text-gray-600 text-center">Jumlah Stock Produk Yang tersedia</h5>
            ...
            <div>
                <div class="h-full py-6 px-6 rounded-xl border border-gray-200 bg-white">
                    <h5 class="text-xl text-gray-700">Jumlah Stock Bahan Baku</h5>
                    <div class="my-8">
                    </div>
                        ...
                        <tbody>
                            @foreach ($stock as $stocks)
                                <tr>
                                    ...
                                    <td class="@if ($stocks->jumlah_stock < 21) text-red-500 @else text-green-500 @endif">
                                        {{ $stocks->jumlah_stock }}</td>
                                </tr>
                            @endforeach
                        </tbody>
                    </table>
            ...
            <div>
                <div class="lg:h-full py-8 px-6 text-gray-600 rounded-xl border border-gray-200 bg-white">
                    ...
                    <div class="mt-6">
                        <h5 class="text-xl text-gray-700 text-center"> Jumlah Pemesanan Belum Terkirim {{ $pesan }}
                        </h5>
                        {{-- <div class="mt-2 flex justify-center gap-4">
...
@can('Manage-Supplier')
    <livewire:items.page-bahan-baku>
    @endcan
